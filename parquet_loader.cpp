...
// Read `column` out of `path` as a contiguous vector<T>.
template <typename T>
...
template std::vector<double>       load_column<double>(const std::string&, const std::string&, double, ColumnInfo*);
template std::vector<float>        load_column<float>(const std::string&, const std::string&, float, ColumnInfo*);
template std::vector<std::int64_t> load_column<std::int64_t>(const std::string&, const std::string&, std::int64_t, ColumnInfo*);
template std::vector<std::int32_t> load_column<std::int32_t>(const std::string&, const std::string&, std::int32_t, ColumnInfo*);
